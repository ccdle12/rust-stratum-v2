use stratumv2_messages_sdk::impl_error_code_enum;

// TODO: Update the doc comments and make sure they match the links
...
pub mod open_mining_channel_error_macro_prelude {
    pub use super::OpenMiningChannelErrorCode;
    pub use stratumv2_messages_sdk::impl_message;
}

// TODO:
// Add notes explaining why we have an open mining channel error for both extended and standard,
// because of the different message types
// Remove the result so that we don't deserialize messages using the constructor
#[doc(hidden)]
#[macro_export]
macro_rules! impl_open_mining_channel_error {
    ($struct_name:ident) => {
        use crate::open_mining_channel_error::open_mining_channel_error_macro_prelude::*;
        ...
        impl $struct_name {
            pub fn new(request_id: u32, error_code: OpenMiningChannelErrorCode) -> Result<$struct_name, stratumv2_serde::Error> {
                Ok($struct_name {
                    request_id,
                    error_code,
                })
...
pub mod test_macro_prelude {
    pub use stratumv2_messages_sdk::impl_message_tests;
}
...
macro_rules! impl_open_mining_channel_error_tests {
    ($struct_name:ident) => {
        use crate::open_mining_channel_error::test_macro_prelude::*;
        ...
        fn make_serialized_open_mining_channel_error() -> Vec<u8> {
            vec![
                ...
                0x0c, 0x75, 0x6e, 0x6b, 0x6e, 0x6f, 0x77, 0x6e, 0x2d, 0x75, 0x73, 0x65,
                0x72, // error_code
            ]
        }
