...
use stratumv2_serde::types::U256;
...
// TODO: Remove the dependency on having to call the constructor on deserialization
impl UpdateChannel {
    pub fn new<U: Into<U256>>(
        channel_id: u32,
        nominal_hash_rate: f32,
        max_target: U,
    ) -> Result<UpdateChannel, stratumv2_serde::Error> {
        Ok(UpdateChannel {
            channel_id,
            nominal_hash_rate,
