use stratumv2_messages_sdk::impl_setup_connection;
...
// SetupConnection is an implementation of the SetupConnection message specific
// to the mining subprotocol and will contain the mining SetupConnectionFlags.
impl_setup_connection!(SetupConnectionFlags);

#[cfg(test)]
mod tests {
    use super::*;
    use stratumv2_messages_sdk::impl_setup_connection_tests;
