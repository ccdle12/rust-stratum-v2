...
pub struct InternalSetupConnection
// pub struct InternalSetupConnection<B>
// where
...
// impl<B> InternalSetupConnection<B>
// where
// B: BitFlag + ToProtocol,
// {
impl InternalSetupConnection {
    pub fn new<T: Into<String>>(
        ...
        firmware: T,
        device_id: T,
    ) -> Result<InternalSetupConnection> {
    ...
    // fn deserialize(bytes: &[u8]) -> Result<InternalSetupConnection> {
    ...
    // // let flags = B::to_vec_flags(set_flags);
...
// TODO: Move the doc strings to public impl level
...
// impl<B> Serializable for InternalSetupConnection<B>
// where
// B: BitFlag + ToProtocol,
impl Serializable for InternalSetupConnection {
